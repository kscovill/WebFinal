        ...
        */
        me.handleDeath = function() {
            function recordScore () {
                var highScore = sessionStorage.jsSnakeHighScore;
                if (highScore == undefined) sessionStorage.setItem('jsSnakeHighScore', me.snakeLength);
                if (me.snakeLength > highScore) {
                	document.getElementById('high-score-box').value = me.snakeLength;
                    alert('Congratulations! You have beaten your previous high score, which was ' + highScore + '.');
                    sessionStorage.setItem('jsSnakeHighScore', me.snakeLength);
